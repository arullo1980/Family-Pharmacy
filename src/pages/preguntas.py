FAQ = [
    ...
    ("¿Cuándo recibo el dinero?", "El siguiente día hábil después de la venta, en pesos dominicanos, por estación. El estado de cuenta detalla cada turno."),
    ...
    ("¿Cuánto cuesta la terminal?", "En la primera ola no hay cargo por la terminal ni cuota mensual mínima. Si se cancela el contrato, se devuelve la terminal."),
    ...
    ("¿Cómo se calcula la tarifa?", "Pesos por galón vendido con tarjeta, con un tope como porcentaje de la venta. En el estado de cuenta verá el intercambio, la tarifa de la red y nuestra tarifa por separado."),
    ...
    ("¿Wallet Partners retiene mi dinero?", "No. Los fondos se liquidan a través de una cuenta del programa controlada por el banco patrocinador y se transfieren a su cuenta al día siguiente hábil."),
