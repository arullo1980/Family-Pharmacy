...
<h2>1. Responsable</h2><p>Wallet Partners LLC ("Wallet Partners", "nosotros") opera este sitio. Para consultas sobre esta política o para ejercer sus derechos escriba a <a href="mailto:{e}">{e}</a>.</p>
...
<p>No usamos rastreadores publicitarios, scripts de analítica ni píxeles de redes sociales. Los mosaicos del mapa se cargan desde servidores de CARTO y OpenStreetMap, que reciben su dirección IP al solicitarlos.</p>
...
<h2>6. Transferencias internacionales</h2><p>Wallet Partners está constituida en Estados Unidos y usa proveedores en la nube, por lo que los datos pueden tratarse fuera de la República Dominicana con salvaguardas contractuales y las medidas de seguridad descritas abajo.</p>
...
<h2>Contenido de terceros</h2><p>El mapa interactivo carga mosaicos desde CARTO / OpenStreetMap. Esas solicitudes revelan su dirección IP al proveedor, pero no colocan cookies en este sitio.</p>
...
<h2>Operador del sitio</h2><p><strong>Wallet Partners LLC</strong><br />Sociedad de responsabilidad limitada constituida bajo las leyes de Estados Unidos.<br />Correo: <a href="mailto:{e}">{e}</a></p>
...
<h2>Marcas</h2><p>"Wallet Partners" y su logotipo son marcas de Wallet Partners LLC. TotalEnergies, Shell, Texaco, Next, Axxon, Tropigás, Sigma, VP Racing, Óptimo Gas, Trovasa, Visa, Mastercard, CardNET, AZUL, Visanet y otros nombres pertenecen a sus titulares y se citan solo para identificar ubicaciones y participantes del mercado, sin implicar patrocinio, afiliación ni respaldo.</p>
<h2>Contenido e imágenes</h2><p>Los datos de estaciones se compilaron de listados públicos el {ctx['DATA_DATE']}. Las fotografías del sitio son ilustraciones generadas por computadora y no representan estaciones, personas ni marcas concretas. Datos del mapa © colaboradores de OpenStreetMap (ODbL); mapa base © CARTO.</p>
