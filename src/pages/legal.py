...
<p>No usamos rastreadores publicitarios, scripts de analítica ni píxeles de redes sociales. Los mosaicos del mapa se cargan desde servidores de OpenStreetMap, que reciben su dirección IP al solicitarlos.</p>
...
<h2>5. Propiedad intelectual</h2><p>Textos, gráficos, código y el conjunto de datos de estaciones son © Wallet Partners LLC salvo indicación contraria. Los datos y el mapa base son © colaboradores de OpenStreetMap (ODbL). Las marcas de combustible pertenecen a sus titulares y se citan solo para identificar ubicaciones, sin implicar afiliación ni respaldo.</p>
...
<h2>Contenido de terceros</h2><p>El mapa interactivo carga mosaicos desde OpenStreetMap. Esas solicitudes revelan su dirección IP al proveedor, pero no colocan cookies en este sitio.</p>
...
<h2>Contenido e imágenes</h2><p>Los datos de estaciones se compilaron de listados públicos el {ctx['DATA_DATE']}. Las fotografías del sitio son ilustraciones generadas por computadora y no representan estaciones, personas ni marcas concretas. Datos y mapa base © colaboradores de OpenStreetMap (ODbL).</p>
